...
{
    internal class ZetaMaximizedForWindows : IDeviceProfile
    {
        public byte[] GetPrimaryGPT()
        {
            ...
            return [
                .. PrimaryMBR,
                .. GPTUtils.MakeGPT(DiskSize, SectorSize, Constants.OEMZE_UFS_LUN_0_PARTITIONS, IsBackupGPT: false, SplitInHalf: false)
            ];
        }
        ...
        {
            return $"OEMZE_MaximizedForWindows_{OSVersion}_CLIENT{Sku}_a64fre_{Language}_unsigned.ffu";
        }
